...
<div>
	<div
		class="noscrollbar align-center m-1 flex flex-col justify-start overflow-y-scroll px-32 text-left text-lg"
	>
		<hr class="mx-auto my-4 w-full border-translucent" />
		<div class="w-11/12 text-justify">
			<p class="mb-3 mt-1 flex w-full text-3xl tracking-widest text-pink">DISCLAIMER</p> 
			<p class="my-2">
				⇀ You must be at least <span class="font-black">18 years old</span> to request a commission.
			</p>
			<p class="my-2">⇀ I retain the right to reject any request / commission for any reason.</p>
			<p class="my-2">
				⇀ I only accept a limited number of slots at a time; however, a <span class="font-black"
					>waitlist</span
				>
				is <span class="font-black">available</span> in my
				<a href="https://discord.gg/kkQHDmhRzN" class="underline text-pink">Discord</a>.
			</p>
			<p class="my-2">
		...
		<div>
			...
			<p class="my-2">
				<span class="text-red">✖</span> <span class="font-black">DO NOT</span> sell, profit from, or
			...
			<p class="my-2">
				<span class="text-red">✖</span> <span class="font-black">DO NOT</span> modify or claim the work
				as your own.
			</p>
			<p class="my-2">
				<span class="text-red">✖</span> Under no circumstances do I allow my work to be used /
				turned into an NFT or to be used for AI in <span class="font-black">ANY WAY</span>. You will
		...
		<div>
			...
			<p class="mt-2">
				⇀ Refunds and cancellation are guaranteed <span class="font-black">ONLY BEFORE</span> I begin
			...
			<p class="my-2">
				⇀ <span class="font-black">Partial refund</span> are guaranteed upon the artist's inability to
				complete the project.
			</p>
			<p class="my-2">
				⇀ <span class="font-black">Partial refund</span> are offered upon the artist's inability to complete
		...
		<div>
			...
			<p class="mt-2">
				⇀ If you do not wish for me to share the work <span class="font-black">at all (no posting on socials)</span>, an
			...
			<p class="my-2">
				...
				as a sample for my commission site <span class="font-black">( if no NDA )</span>.
			</p>
		</div>
	</div>
</div>
