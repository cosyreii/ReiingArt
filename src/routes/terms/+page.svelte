...
<div
	class="m-4 mx-8 flex flex-col items-center justify-center rounded-3xl border-2 border-dashed border-red bg-red/20 p-2 text-center text-xl italic"
>
...
<div class="align-center m-1 flex flex-col justify-start px-20 text-left text-lg max-md:px-3">
	...
	<div>
		...
		<p class="ml-4 flex flex-row items-center text-base text-translucent">
			<img src="https://i.imgur.com/noUP00a.png" alt="sub info" class="mr-1 size-2" /> Completely scrapping
	...
	<div>
		...
		>
			<p class="mb-3 mr-2 mt-1 flex text-3xl font-black tracking-widest">COPYRIGHT / USAGE</p>
		...
		<p class="my-2">
			...
			<span class="mx-1 bg-pink/25 font-black text-[#ffffff]">ANY WAY</span>. Violations will result
			in immediate blacklisting and
			<span class="mx-1 bg-pink/25 font-black text-[#ffffff]">forfeiture of IP</span> towards the purchased
			artwork.
		</p>
	</div>
	...
	<div>
		...
		<p class="ml-4 flex flex-row items-center text-base text-translucent">
			<img src="https://i.imgur.com/noUP00a.png" alt="sub info" class="mr-1 size-2" /> It is your responsibility
