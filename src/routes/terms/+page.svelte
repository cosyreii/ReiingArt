...
<div
	class="m-4 mx-40 flex flex-col items-center justify-center rounded-full border-2 border-dashed border-red bg-red/20 p-6 text-center text-xl italic max-lg:mx-20 max-md:rounded-3xl"
>
...
<div
	class="noscrollbar align-center m-1 flex flex-col justify-start overflow-y-scroll px-20 text-left text-lg max-md:px-10"
>
	...
	<div>
		...
		<p class="mt-2">
			⇀ Refunds and cancellation are guaranteed <span class="font-black">ONLY BEFORE</span> I begin work.
	...
	<div>
		...
		<p class="my-2">
			...
			a sample for my commission site <span class="font-black">( if no NDA )</span>.
		</p>
	</div>
</div>
